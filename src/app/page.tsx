            ...
            <div className="col-12 col-md-6">
              ...
              >
                ...
                <p className="fs-6 mb-5">
                  ...
                  we&apos;ll bring it to life with a sneaky twist - within
                  reason, of course! A limited collection of user-requested and
                  community approved pieces that can feature anybody, from Jimi
                  Hendrix to The Teletubbies.
                </p>
                <h5 className="fw-bold mb-0">Traits</h5>
                <p className="lead fs-6">
            ...
            <div className="col-12 col-md-6">
              ...
              >
                ...
                <p className="lead fs-6">
                  ...
                  holders, through our ingenious &quot;Plush Fund&quot; program.
                  Be sure to join our Discord to learn more about that.
                </p>
              </div>
            </div>
            <div className="col-12">
