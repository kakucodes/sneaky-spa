...
export const ConnectedButton = () => {
  ...
  return (
    <div>
      <p onClick={() => setDropdownOpen((open) => !open)}>
        <span>Hi, {name}!</span>
        <br />(
